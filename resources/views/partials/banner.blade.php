                ...
                <div class="row">
                    <div class="col-lg-12 col-md-8">
                        <div class="slide__content--headings ttm-textcolor-white text-left">
                            ...
                            <h2 data-animation="fadeInDown" data-delay="0.1s">L’<span class="ttm-textcolor-skincolor">Audit</span> est <br>notre cœur de métier</h2>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 col-md-8">
                        <div class="slide__content--headings ttm-textcolor-white text-left">
                            <img class="ECLogo" src="{{ asset((!\App::environment('local') ? 'public/' : '') . 'storage/images/logo_oec.png') }}" alt="Logo Ordre des experts comptables">
                            <h2 data-animation="fadeInDown" data-delay="0.1s">Un <span class="ttm-textcolor-skincolor">Audit</span> <br>personnalisé</h2>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-8">
                        <div class="slide__content--headings ttm-textcolor-white text-left">
                            ...
                            <div class="d-inline-block margin_top20" data-animation="fadeInUp" data-delay="0.6s">
                                <a class="ttm-btn ttm-btn-size-md  ttm-btn-shape-rounded ttm-btn-style-fill ttm-icon-btn-right ttm-btn-color-skincolor" href="#cabinets">Le cabinet<i class="flaticon flaticon-right-arrow"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
