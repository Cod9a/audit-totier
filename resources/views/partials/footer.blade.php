                ...
                <div class="widget-area col-xs-12 col-sm-6 col-md-6 col-lg-4">
                    <div class="widget widget_text  clearfix">
                        <div class="footer-logo">
                           <img id="logo-img-1" class="img-center standardlogo" src="{{ asset((!\App::environment('local') ? 'public/' : '') . 'storage/images/AT.png') }}" alt="Logo du Cabinet EZIN & STRAUUS">
                        </div>
                    ...
                    <div class="widget widget_nav_menu clearfix">
                       <h3 class="widget-title">Menu</h3>
                        <ul class="menu-footer-quick-links">
                            ...
                            <li><a href="{{ route('index') }}#cabinets">Le Cabinet De Montrouge</a></li> 
                    ...
                    <div class="widget widget_nav_menu res-991-margin_top30 clearfix">
                       <h3 class="widget-title">Contacts</h3>
                        <ul class="menu-footer-quick-service-links">
                            <li><a href="tel:0141779350"><i class="fa fa-phone"></i> 01 41 77 93 50</a></li>  
                            <li><a href="mailto:contact@audit-totier.fr"><i class="fa fa-envelope"></i>  contact@audit-totier.fr</a></li>
                        </ul>
                    </div>
                </div>
            </div>  
        ...
        <div class="bottom-footer-text ">
            <div class="row copyright text-center">
                <div class="col-lg-12 col-md-12 col-sm-12 d-md-flex d-sm-block justify-content-center">
                    <span>Copyright &#169; 2021 <a href="{{ route('index') }}"> Audit TOTIER.</a>Tous droits réservés.</span>
